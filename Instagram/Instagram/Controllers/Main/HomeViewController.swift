...
class HomeViewController: UIViewController {
    ...
    private var viewModels = [[HomeCellType]]()
...
//        let postData: [HomeCellType] = [
//            .poster(viewModel: PosterCollectionViewCellViewModel(
//                        username: "John Doe",
//                        profilePictureURL: URL(string: "https://pbs.twimg.com/profile_images/1296204526232444937/aWKCu_-J.jpg")!)),
//            .post(viewModel: PostCollectionViewCellViewModel(postUrl: URL(string: "https://pbs.twimg.com/profile_images/1296204526232444937/aWKCu_-J.jpg")!)),
//            .actions(viewModel: PostActionsCollectionViewCellViewModel(isLiked: true)),
//            .likeCount(viewModel: PostLikesCollectionViewCellViewModel(likers: ["Jane Doe"])),
//            .caption(viewModel: PostCaptionCollectionViewCellViewModel(username: "John Doe", caption: "Test")),
//            .timestamp(viewModel: PostDateCollectionViewCellViewModel(date: Date()))
//        ]
//
    ...
    private func createViewModel(
        ...
        StorageManager.shared.profilePictureURL(for: username) { [weak self] profilePictureURL in
            ...
            let postData: [HomeCellType] = [
                ...
                .timestamp(
                    viewModel: PostDateCollectionViewCellViewModel(
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .caption(let viewModel):
            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: PostCaptionsCollectionViewCell.identifier,
                for: indexPath
        ...
        case .timestamp(let viewModel):
            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: PostDateCollectionViewCell.identifier,
                for: indexPath
...
extension HomeViewController {
    func configureCollectionView() {
        ...
        collectionView.register(
            PostCaptionsCollectionViewCell.self,
            forCellWithReuseIdentifier: PostCaptionsCollectionViewCell.identifier
        )
        collectionView.register(
            PostDateCollectionViewCell.self,
            forCellWithReuseIdentifier: PostDateCollectionViewCell.identifier
        )
